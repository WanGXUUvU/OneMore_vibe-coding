...
| 2026-07-01 | 新增 Gemini 平台支持与交互式头脑风暴对齐指南 | generate.sh, minipower/SKILL.md | Completed | 1. 扩充平台选项以完美支持 Gemini/Antigravity（项目级 `.agents/AGENTS.md` 与 `.agents/skills/minipower/`，全局 `~/.gemini/config/skills/`）；2. 在 SKILL.md 中制定了详细的头脑风暴“交互式对齐三部曲”和“一次追问 1-3 个问题”的交互规范。 |
